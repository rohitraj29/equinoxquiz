                ...
                <div id="content">
                    ...
                    <h:form>
                        ...
                        <h:panelGrid columns="2" width="500">
                            ...
                            <h:inputText value="#{CreateUserBean.username}"/>
                            <h:outputText value="Password"/>
                            <h:inputSecret value="#{CreateUserBean.password}"/>
                            <h:outputText value="SelectRole"/>
                            <h:selectOneMenu value="#{CreateUserBean.role}">
                                <f:selectItem itemLabel="User" itemValue="User"/>
                                <f:selectItem itemLabel="Administrator" itemValue="Administrator"/>
                            </h:selectOneMenu>
                            <h:commandButton value="Submit" action="#{CreateUserBean.persist}"/>
