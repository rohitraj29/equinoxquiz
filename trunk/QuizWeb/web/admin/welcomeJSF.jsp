    ...
    <body>
        <f:view>
            ...
            <div id="headerbg">
                ...
                <p class="text1">&#8220;In Search of Excellence in realms <br />
                of the World&#8221;</p>
            </div>
            <!-- start page -->
            <div id="page">
                    ...
                    <div id="latest-posts">
                        <h:form id="form1">
                            <h:panelGrid id="panel1">
                                <a4j:commandButton  id="show"action="#{DataAdminBean.resetDataBase}"  value="Reset the Complete DataBase Proceed With Extreme Caution"/>
                                <rich:componentControl attachTo="show" event="onclick" for="msg1" operation="show"/>
                                <rich:modalPanel id="msg1" label="Message" width="200" height="150">
                                    <h:panelGrid>
                                        <h:outputText value="DataBase Reset SuccessFull Proceed with adding test Entries and preparing database for Quiz"/>
                                        <a4j:commandButton id="close"value="OK"/>
                                        <rich:componentControl attachTo="close" for="msg1" event="onclick" operation="hide"/>
                                    </h:panelGrid>
