                ...
                <div id="content">
                    ...
                    <h:form>
                        ...
                        <h:panelGrid columns="2" width="500">
                            <h:outputText value="From User ID"/>
                            <h:inputText value="#{GenerateUser.fromid}">
                                <a4j:support ajaxSingle="true" immediate="true" event="onblur"/>
                            </h:inputText>
                            <h:outputText value="To User ID"/>
                            <h:inputText value="#{GenerateUser.toid}">
                            <a4j:support ajaxSingle="true" immediate="true" event="onblur"/>
                            </h:inputText>
                            <h:commandButton value="Generate" action="#{GenerateUser.persist}"/>
                        </h:panelGrid>
                    </h:form>
